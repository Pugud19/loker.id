<nav x-data="{ open: false }" class="bg-white border-b border-gray-300">
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a class="flex items-end space-x-4 whitespace-nowrap bg-blur-lg rounded-lg" href="{{ route('dashboard') }}">
                      <span class="text-5xl font-bold leading-none text-blue-600">Loker.id</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('lokers')" :active="request()->routeIs('lokers')">
                        {{ __('loker') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('lokers')" :active="request()->routeIs('lokers')">
                {{ __('Loker') }}
            </x-responsive-nav-link>
